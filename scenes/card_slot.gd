...
@export var slot_player_type: Enum.PLAYER_TYPE = Enum.PLAYER_TYPE.PLAYER

@onready var slot_texture: TextureRect = $Texture


func can_put_this_card(card: Card, player_type: Enum.PLAYER_TYPE) -> bool:
...
func insert_card(card: Card, player_type: Enum.PLAYER_TYPE):
